...
export default function BillingPOSModal({
  ...
  return (
    ...
    >
      <div
        data-lenis-prevent
        className="bg-slate-900 border border-amber-500/30 rounded-2xl w-full max-w-4xl max-h-[92vh] flex flex-col overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200"
      >
        {/* Modal Header */}
        <div className="px-6 py-4 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 border-b border-amber-500/20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-amber-200/60 leading-tight">Dynamic Line Items, Custom Dental Procedures &amp; Instant UPI QR</p>
            </div>
          </div>
