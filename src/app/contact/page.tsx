        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7">
            <MotionReveal direction="right" delay={0.1}>
              <div className="bg-white dark:bg-[#181715] p-6 sm:p-10 rounded-3xl border border-[#C9A227]/25 shadow-xl">
                ...
                {success ? (
                  <div className="p-8 rounded-2xl bg-green-50 dark:bg-green-950/40 border border-green-200 dark:border-green-800/40 text-center space-y-3">
                    ...
                    <button
                      ...
                      className="mt-4 text-xs font-bold text-[#C9A227] underline cursor-pointer"
                    >
