            ...
            <div className="p-6 bg-[#FAF8F5] dark:bg-[#121110] border-t border-[#E8E0D2] dark:border-[#26231E] flex flex-wrap items-center justify-center sm:justify-between gap-3">
              <div className="flex flex-wrap gap-2">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 bg-white dark:bg-[#1C1A17] hover:bg-[#FAF8F5] border border-[#C9A227]/40 text-[#1A1A1A] dark:text-white font-semibold text-xs py-2 px-3.5 rounded-xl shadow-sm transition-all cursor-pointer"
                >
